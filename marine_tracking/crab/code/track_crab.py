...
video_directory='E:/hydrothermal/2020-2021_enhance'
...
for filename in os.listdir(video_directory):
    if filename.endswith(('.mp4','.mkv')):
        ...
        while capture.isOpened():
            ...
            if results[0].boxes.id is not None:
                ...
                for box,track_id,cls,conf in zip(boxs,track_ids,clss,confs):
                    if cls == 0 :##0:crab,1:crab_small,2:mussel
                        x1,y1,x2,y2=box
                        bbox_width_px = x2 - x1
                        ...
                        if len(track) > 1:
                            ...
                            if distance_mm > 1.5:  # Filter small movements smaller than 1.5 mm
        ...
        with open('sum_of_all_crab_distances_model7_mm.txt','a+',encoding='utf-8')as f2:
