...
def update_track_info(tracks, detections_list, track_history, track_confidences,
    ...
    for track in tracks:
        ...
        if (hist['age']          >= MIN_TRACK_AGE and
            ...
            with open("./example/acceleration_event-onevideo.txt", 'a+', encoding='utf-8') as f1:
                f1.write(
...
if __name__ == '__main__':
    ...
    video_path = "/home/jingyichu/data/2017_2018/2017_2018/SMOOVE-17-11-28_23-58-37-11.mkv"
    out_path = './example/SMOOVE-17-11-28_23-58-37-11.mp4'
    main(MODEL_PATH, video_path,out_path)
