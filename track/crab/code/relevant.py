...
crab = pd.read_csv("D:/marine_tracking/crab/distance_results/2017-2018.csv", parse_dates=["time"])
crab = crab.rename(columns={"time": "date", " distance_permin": "distance/mm"})
crab["date"] = crab["date"].dt.normalize()  # Keep only the date part

# Read tide data
tide = pd.read_csv('D:/marine_tracking/shrimp/tide/2017-2018tide.csv')
